...
波段锁点：反弹用 Low+(H-L)×0.382/0.618；近 BOLL 中轨=共振；日线定调优先，高周期未成熟只做短线反抽；二破/回踩站稳优先；必给失效位。腰斩线以下不追空；4h以下无顶背离回踩=诱空；虚破收回仍可头仓；周BOLL中轨非空目标。日周+小时走强则市价冲；3日/5日金叉或空心阳=加速不猜顶；近0.618鱼尾不加仓。
